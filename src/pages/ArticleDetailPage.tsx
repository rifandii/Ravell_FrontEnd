  ...
  const components: Components = {
    ...
    h2: ({ children }) => {
      ...
      return (
        <h2
          id={id}
          className="group flex items-center gap-2 text-2xl md:text-3xl font-bold mt-12 mb-6 text-gray-900 dark:text-white scroll-mt-24"
        >
          {children}
          <a
            href={`#${id}`}
    ...
    <div className="w-full pb-20 animate-in fade-in duration-500">
      <Helmet>
        ...
        <meta
          name="description"
          content={
            article.summary || `Read comprehensive guide about ${article.title}`
          }
        />
        ...
        <div className="max-w-5xl mx-auto px-4 md:px-8 mb-12 md:mb-16">
          <div className="relative rounded-3xl overflow-hidden shadow-2xl shadow-blue-900/10 aspect-video group">
            <img
              ...
              onClick={() =>
                setZoomedImageUrl(article.featured_image_url || null)
              }
              loading="eager"
            />
